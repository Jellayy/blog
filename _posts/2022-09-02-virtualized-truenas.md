...
date: 2022-09-02
categories: [Guides]
tags: [PROXMOX, TRUENAS, VIRTUALIZATION, NAS, HOMELAB]
media_subpath: /assets/post-assets/2022-09-02-virtualized-truenas
image:
  path: truenas-guide.jpg
---
...
1. When you find the serial identifier of the drive you want to add, you can bind it to your VM with:
...
1. If everything was done correctly, you should see any drives you add in your VM's hardware section:
